...
(def by-id
  {"01"     "alkohole",
   ...
   "010108" "wino migracja",
   "0103"   "piwo",
   "010301" "piwo w butelce",
   "010302" "piwo w puszce",
   "0104"   "alkohole mocne",
   "010401" "brandy, gin, rum",
   "010402" "drinki",
   "010403" "likiery",
   "010404" "whisky",
   "010405" "wódka",
   "010406" "alkohole migracja",
   "02"     "chemia",
   "0202"   "kosmetyki",
   ...
   "050203" "lody",
   "050204" "mięso mrożone",
   "050205" "owoce i warzywa mrożone",
   "050206" "ryby i owoce morza mrożone",
   "050207" "ryby i owoce morza mrożone - przecena",
   "050208" "mrożonki migracja",
   ...
   "100211" "pieczywo regionalne - ciasta luz",
  ...
  (e/memoize
   (fn [category-id]
     (when (>= (count category-id) 2)
       (str/join " - " (filter identity (flatten (cons (full-name (apply str (drop-last 2 category-id))) [(get by-id category-id)]))))))))
